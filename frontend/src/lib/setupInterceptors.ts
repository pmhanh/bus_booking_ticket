...
import { api, getAccessToken, setAccessToken, type AuthAxiosRequestConfig } from './api';
...
// Convenience bootstrap in case other modules need the default behavior.
export function initDefaultInterceptors(logout: () => void) {
